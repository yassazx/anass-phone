...
4. **Add environment variables** (`VITE_SUPABASE_URL`, `VITE_SUPABASE_ANON_KEY`, `VITE_WHATSAPP_NUMBER`, `VITE_CLOUDINARY_CLOUD_NAME`, `VITE_CLOUDINARY_UPLOAD_PRESET`, optional `VITE_BACKOFFICE_PASSWORD`) under *App settings → Environment variables*. These populate `import.meta.env` during the build.
